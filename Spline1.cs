...
{
    public partial class Spline1 : DevComponents.DotNetBar.OfficeForm
    {
        public IMap pMap;
        ...
        private void Spline1_Load(object sender, EventArgs e)
        {
            //清空选项
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string splineType = (string)comboBox3.SelectedItem;//样条函数类型
            double weight = double.Parse(textBox3.Text);//权重
            int numPoints = int.Parse(textBox4.Text);//点数
            ...
            spline.in_point_features = layer;
            spline.z_field = Zfield;
            spline.out_raster = outRaster;
            spline.cell_size = cellSize;
            spline.spline_type = splineType;
            spline.weight = weight;
            spline.number_points = numPoints;
            //执行GP工具
            IGeoProcessorResult results = (IGeoProcessorResult)gp.Execute(spline, null);
            #endregion
